...
/**
 * @brief The EditMatchWidget class is a widget allowing to create a new match.
 */
class EditMatchWidget : public QWidget
{
public:
	/**
     * @brief Constructor of the EditMatchWidget class.
     * @param parent : The parent item of the widget.
     */
	explicit EditMatchWidget(QWidget *parent = 0);
	/**
     * @brief Destructor.
     */
	~EditMatchWidget();
